...
const selectArea = {
  ...
  confirm:function(e, _this) {
    _this.setData({
      ...
      area_ids:{
        area_pid:_this.data.selectedProvince.id,
        area_pname:_this.data.selectedProvince.alias,
        area_cid:_this.data.selectedCity.id,
        area_cname:_this.data.selectedCity.alias,
        area_xid:_this.data.selectedDistrict.id,
        area_xname:_this.data.selectedDistrict.alias,
      },
      ischoose_area: true, 
      isShow: false,
      address_actionSheetHidden:true
